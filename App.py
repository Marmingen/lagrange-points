...
class App():
    ...
    def __init__(self):
        ...
        #############################################################
        # initializing all points, bodies, lines, and the star
    ...
    def reset(self):
        ...
        self.star = Star(self.canvas, pos=(self.width,self.width))
        self.body = Body(self.canvas, pos=(self.width+150, self.width))
        
        # setting up the lagrange points
